RealCP <- function(data=CPdataAllCrit, method="intersect", 
                   index_names=c("DSlatency", "DSrespAll", "DStaskAcc", "DStimeToSpare", "ITIlatency", "ITIrespRatio", "NSlatency", "NSrespAll", "NStaskAcc", "NStimeToSpare"), rats=rats){
        #In the object "CPdataAllCrit", these are the levels:
        # [[x]] --> Rat
        # [[y]] --> Index
        # [[z]] --> Significance criterion in Gallistel's algorithm
