...
datafolder <- paste(getwd(), "/EXP3B_Not down/MedPC files/", sep="")
dataForRdir <- paste(getwd(), "/EXP3B_Not down/Data for R/", sep="")
dataForRCumulative <- paste(getwd(), "/EXP3B_Not down/Data for R cumulative/", sep="")
behGraphFolder <- paste(getwd(), "/EXP3B_Not down/Graphs/Behavior/", sep="")
CPfuncFolder <- paste(funcdirect, 'Change_Point-master/', sep="")
CPGraphFolder <- paste(getwd(), "/EXP3B_Not down/Graphs/Behavior/Change point/", sep="")
MixedGraphFolder <- paste(getwd(), "/EXP3B_Not down/Graphs/Mixed/", sep="")
NEXfiles <- paste(getwd(), "/EXP3B_Not down/NEX files/", sep="")
IndcumPerfGraphFolder <- paste(getwd(), "/EXP3B_Not down/Graphs/Behavior/Cumulative perf/", sep="")
PerfRelToCPFolder <- paste(getwd(), "/EXP3B_Not down/Graphs/Behavior/Beh rel to CP/", sep="")
BySessFolder <- paste(MixedGraphFolder, "By Sess from CP/", sep="")
ScatterplotFolder <- paste(MixedGraphFolder, "Scatterplot/", sep="")
otherGraphFolder <- paste(getwd(), "/EXP3B_Not down/Graphs/Others/", sep="")
