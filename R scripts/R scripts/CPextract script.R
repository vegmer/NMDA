CPextract <- function(GallCrit=1.3, minSlope=0.5, adjDrop=-0, idx, plot=T, CPfuncFolder, CPGraphFolder, dataForRdir, dataForRCumulative){
        ...
        #At one point I'll have to figure this out (how to adjust the analysis by dependent variable). Right now I've only done it for S+ task accuracy/specificity
        # if(DV=="DSspecif")<- {
        #         
        # }
...
save(CPextract, file=paste("E:/Dropbox/NMDA/EXP3_NAc FR acquisition/R functions/CPextract.R"))
