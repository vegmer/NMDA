cp_wrapper3 <- function(Data, isDiscrete, test, Crit, ratname, index, graphFolder)
{
        # 
        ...
        #### Plotting   ####
        ####################
        titlelabel = paste(ratname, index[2], Crit, sep="_")
        subFolder = paste(graphFolder, index[1], "/", Crit, sep="")
        filetitle = paste(subFolder, "/", paste(ratname, index[1], Crit), ".pdf", sep="")
...
save(cp_wrapper3, file="E:/Dropbox/NMDA/R functions/cp_wrapper3.R")
save(cp_wrapper3, file="E:/Dropbox/NMDA/EXP3_NAc FR acquisition/R functions/cp_wrapper3.R")
